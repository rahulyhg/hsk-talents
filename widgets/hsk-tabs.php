 ...
 * Accordion
 */ 
function hsk_tabs_accordions_shortcode( $atts, $content ) {
    ...
    $content = do_shortcode( hsk_shortcode_unautop( shortcode_unautop( hsk_up_shortcodes( $content ) ) ) );
    $html  = '';
    if (!empty($atts['title'])) {
...
add_shortcode( 'accordions', 'hsk_tabs_accordions_shortcode' );
 ...
 */
function hsk_tabs_accordion_shortcode( $atts, $content ) {
    ...
    $content = do_shortcode( hsk_shortcode_unautop( shortcode_unautop( $content ) ) );
...
add_shortcode( 'accordion', 'hsk_tabs_accordion_shortcode' );
function hsk_tabs_haccordions_shortcode( $atts, $content ) {
...
add_shortcode( 'haccordions', 'hsk_tabs_haccordions_shortcode' );
function hsk_tabs_haccordion_shortcode( $atts, $content ) {
...
add_shortcode( 'haccordion', 'hsk_tabs_haccordion_shortcode' );

/**
 * Tabs
 */
function hsk_tabs_tabs_shortcode( $atts, $content ) {
...
add_shortcode( 'tabs', 'hsk_tabs_tabs_shortcode' );

function hsk_taba_shortcode( $atts, $content, $tag ) {
...
add_shortcode( 'tab', 'hsk_taba_shortcode' );
/*
 * Toggle
 */

function hsk_tabs_toggles_shortcode( $atts, $content ) {
...
add_shortcode( 'toggles', 'hsk_tabs_toggles_shortcode' );

function hsk_tabs_toggle_shortcode( $atts, $content ) {
...
add_shortcode( 'toggle', 'hsk_tabs_toggle_shortcode' );

if (!function_exists( 'hsk_up_shortcodes' )) :
    function hsk_up_shortcodes( $content ) {
        $html = trim( $content );
...
function hsk_shortcode_unautop( $content ) {
    $html = trim( $content );
